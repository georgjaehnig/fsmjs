...
it('pushWeights', function() {
	...
	wfsm.setI( 0 );
	wfsm.setE( 0, 1, 'a', 'a', 2 );
	wfsm.setE( 1, 15, 'b', 'b', 1 );
	wfsm.setE( 15, 16, 'a', 'a', 0.5 );
	wfsm.setE( 15, 17, 'b', 'b', 0.5 );
	wfsm.setF( 16, 0.1 );
	wfsm.setF( 17, 0.12 );

	wfsm.setE( 0, 2, 'b', 'b', 2 );
	wfsm.setE( 2, 11, 'a', 'a', 0.5 );
	wfsm.setE( 11, 14, 'c', 'c', 1 );
	wfsm.setE( 2, 12, 'b', 'b', 0.5 );
	wfsm.setE( 12, 13, 'c', 'c', 1 );
	wfsm.setF( 14, 0.3 );
	wfsm.setF( 13, 0.02 );

	wfsm.setE( 0, 3, 'c', 'c', 4 );
	wfsm.setE( 3, 4, 'a', 'a', 0.25 );
	wfsm.setE( 4, 10, 'b', 'b', 1 );
	wfsm.setE( 3, 5, 'b', 'b', 0.5 );
	wfsm.setE( 5, 8, 'a', 'a', 0.5 );
	wfsm.setE( 5, 9, 'b', 'b', 0.5 );
	wfsm.setE( 3, 6, 'c', 'c', 0.25 );
	wfsm.setE( 6, 7, 'a', 'a', 1 );
	wfsm.setF( 10, 0.03 );
	wfsm.setF( 8, 0.18 );
	wfsm.setF( 9, 0.07 );
	...
	assert.equal(JSON.stringify(wfsm.Q), '[[{"1":{"a":{"a":0.22}},"2":{"b":{"b":0.32}},"3":{"c":{"c":0.46}}},0,1],[{"15":{"b":{"b":1}}},0,0],[{"11":{"a":{"a":0.9375}},"12":{"b":{"b":0.0625}}},0,0],[{"4":{"a":{"a":0.0652}},"5":{"b":{"b":0.5435}},"6":{"c":{"c":0.3913}}},0,0],[{"10":{"b":{"b":1}}},0,0],[{"8":{"a":{"a":0.72}},"9":{"b":{"b":0.28}}},0,0],[{"7":{"a":{"a":1}}},0,0],[{},1,0],[{},1,0],[{},1,0],[{},1,0],[{"14":{"c":{"c":1}}},0,0],[{"13":{"c":{"c":1}}},0,0],[{},1,0],[{},1,0],[{"16":{"a":{"a":0.4545}},"17":{"b":{"b":0.5455}}},0,0],[{},1,0],[{},1,0]]'); 
...
it('determinize', function() {
	...
	var wfsm = new WFSM();
	wfsm.setE( 0, 1, 'a', 'a', 0.3 );
	wfsm.setE( 1, 1, 'b', 'b', 0.4 );
	wfsm.setE( 1, 3, 'c', 'c', 0.6 );
	wfsm.setE( 0, 2, 'a', 'a', 0.7 );
	wfsm.setE( 2, 2, 'b', 'b', 0.4 );
	wfsm.setE( 2, 3, 'd', 'd', 0.6 );
	wfsm.setI( 0 );
	wfsm.setF( 3 );
